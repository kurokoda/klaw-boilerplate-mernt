...
export const FETCH_ABOUT_PAGE_DATA_SUCCESS = "FETCH_ABOUT_PAGE_DATA_SUCCESS";
...
/**
 * Action dispatched when about page data fetch is requested
 * @returns {object} article of type `FETCH_ABOUT_PAGE_DATA`
 */
 ...
 * @returns {object} article of type `FETCH_ABOUT_PAGE_DATA_SUCCESS`
 */
export function fetchAboutPageDataSuccess(payload: object) {
  return {
    payload,
    type: FETCH_ABOUT_PAGE_DATA_SUCCESS
  };
}
